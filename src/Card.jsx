...
user.map((v,i)=>{
    return  <div className='bg-slate-300  flex flex-wrap items-center  gap-9' key={i}>



    <div className='hover:bg-slate-200 mx-12 max-h-fit p-4 rounded-lg shadow-lg my-3'>
       
       <h2>Id : {v.id} </h2>
        <h2 className='font-bold'>Name :{v.name}  </h2>
        <p>Email : {v.email}</p>
        <h3 className='font-semibold'>Body :{v.body} </h3>
    </div>
